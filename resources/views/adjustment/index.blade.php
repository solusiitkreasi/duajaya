...
<section>
    <div class="container-fluid">
        ...
        <a href="#" data-toggle="modal" data-target="#importAdjustment" class="btn btn-primary"><i class="dripicons-copy"></i> {{trans('file.Import Adjustment')}}</a>
    </div>
...
<div id="importAdjustment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
    <div class="modal-content">
        {!! Form::open(['route' => 'adjustment.import', 'method' => 'post', 'files' => true]) !!}
        <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title">Import Adjustment</h5>
        ...
        <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <a href="public/sample_file/sample_adjustment_stockprice.xls" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i>  {{trans('file.Download')}}</a>
                    </div>
                </div>
        </div>
