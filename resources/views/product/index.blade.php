...
<script>
        ...
        if(product[18]) {
            ...
            if(product_image.length > 1) {
                ...
                for (var i = 0; i < product_image.length; i++) {
                    if(!i)
                        slidertext += '<div class="carousel-item active"><img src="'+url+'/public/images/product/'+product_image[i]+'" height="300" width="100%"></div>';
                    else
                        slidertext += '<div class="carousel-item"><img src="'+url+'/public/images/product/'+product_image[i]+'" height="300" width="100%"></div>';
                }
                ...
                slidertext = '<img src="'+url+'/public/images/product/'+product[18]+'" height="300" width="100%">';
            }
        }
    ...
    $(document).ready(function() {
        ...
        var table = $('#product-data-table').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                url: base_url + "/products/product-data",
                data:{
