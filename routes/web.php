...
Route::group(['middleware' => ['auth', 'active']], function() {
    ...
    Route::get('sales/getproduct/{category_id}/{brand_id}/{product_search}/{warehouse_id}', 'SaleController@getProductByFilter');
	...
	Route::get('sales/gen_receipt/{id}', 'SaleController@genReceipt')->name('sale.receipt');
    ...
    Route::post('importadjustment', 'AdjustmentController@importAdjustment')->name('adjustment.import');
