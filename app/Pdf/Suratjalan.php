...
class Suratjalan extends Fpdf
{
    ...
    public function __construct($data)
    {
        ...
        $this->title_page = $this->data['title_page'];
        $this->general_setting = $this->data['general_setting'];

        $this->halaman=0;
        parent::__construct('P', 'mm', 'A4');
        $this->SetA4();
        $this->SetTitle($this->title_page.'-'.$this->header['reference_no'], true);
    ...
    function Header()
    {
        ...
        $this->cell(0,10,$this->title_page,0,0,'C');
        // $this->Ln(4);
