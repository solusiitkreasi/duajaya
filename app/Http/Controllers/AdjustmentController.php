...
use App\Imports\AdjustmentStokExcelImport;
use App\Warehouse;
...
class AdjustmentController extends Controller
{
    public function index()
    {
        ...
        if( $role->hasPermissionTo('adjustment') ) {
            ...
            return view('adjustment.index', compact('lims_adjustment_all','lims_warehouse_list'));
        }
        else
    ...
    public function importAdjustment(Request $request)
    {
        ...
        $array= Excel::toArray(new AdjustmentStokExcelImport, $file);
        ...
        foreach($array as $key => $val){
            ...
            foreach ($val as $key2 => $val2){
                ...
                if($search==true){
                    ...
                    return redirect('qty_adjustment')->with('message_error', 'Product "'.$val2['product_id'].'" does not exist!');
        ...
        return redirect('qty_adjustment')->with('message', 'Imported successfully');
    }
}
